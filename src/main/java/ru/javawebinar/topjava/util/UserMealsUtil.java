...
public class UserMealsUtil {
    public static void main(String[] args) {
        List<UserMeal> meals = Arrays.asList(
                ...
                new UserMeal(LocalDateTime.of(
                        2020, Month.JANUARY, 31, 0, 0), "Граница", 100),

                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 1, 10, 0), "Завтрак", 500),
                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 1, 13, 0), "Обед", 1000),
                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 1, 20, 0), "Ужин", 500),
                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 2, 10, 0), "Завтрак", 1000),
                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 2, 13, 0), "Обед", 500),
                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 2, 20, 0), "Ужин", 410),
                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 2, 0, 0), "Граница", 100),

                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 3, 11, 0), "Завтрак", 10000),

                new UserMeal(LocalDateTime.of(
                        2020, Month.FEBRUARY, 4, 11, 59), "Завтрак", 100)
        );

        System.out.println(filteredByCycles(
                meals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(filteredByCyclesOptional(
                meals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));

        System.out.println(filteredByStreams(
                meals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(filteredByStreamsOptional(
                meals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
    }
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals,
        ...
        for (UserMeal meal : meals) {
            dayCalories.put(
                    ...
                    dayCalories.getOrDefault(meal.getDateTime().toLocalDate(), 0) + meal.getCalories());
        }
    ...
    public static List<UserMealWithExcess> filteredByCyclesOptional(List<UserMeal> meals,
                                                                    ...
                                                                    int caloriesPerDay) {
        Map<LocalDate, Integer> dayCalories = new HashMap<>();
        Map<LocalDate, AtomicBoolean> dayExcesses = new HashMap<>();
        List<UserMealWithExcess> result = new ArrayList<>();
        for (UserMeal meal : meals) {
            ...
            AtomicBoolean excess = dayExcesses.computeIfAbsent(
                    meal.getDateTime().toLocalDate(),
                    k -> new AtomicBoolean(false));

            if (dayCalorie > caloriesPerDay && !excess.get()) {
                excess.set(true);
            }
    ...
    public static List<UserMealWithExcess> filteredByStreamsOptional(List<UserMeal> meals,
        ...
        return meals.stream().collect(Collector.of(
                () -> new Object() {
                    ...
                    final Map<LocalDate, AtomicBoolean> dayExcesses = new HashMap<>();
                ...
                (acc, meal) -> {
                    ...
                    AtomicBoolean excess = acc.dayExcesses.computeIfAbsent(date, d -> new AtomicBoolean(false));
