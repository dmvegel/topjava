...
public class MealTestData {
    ...
    public static final MatcherFactory.Matcher<Meal> MEAL_WITH_USER_MATCHER = MatcherFactory.usingIgnoringFieldsComparator("user.registered", "user.roles", "user.meals");
